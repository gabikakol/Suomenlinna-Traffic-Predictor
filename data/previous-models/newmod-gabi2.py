...
def predict_traffic():
    ...
    # Ensure the predicted number of passengers is non-negative
    predicted_passengers = max(0, int(predicted_passengers[0]))
    
    print(f"\nPredicted number of passengers: {predicted_passengers}")
